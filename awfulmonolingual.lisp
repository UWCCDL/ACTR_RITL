...
(sdp-fct `(,(no-output (sdm isa arithmetic-fact))
	    :creation-time -10000000 :references 28000))
...
(sdp-fct `(,(no-output (sdm type unary)) :creation-time -10000000 :references 50000))
(sdp-fct `(,(no-output (sdm type binary)) :creation-time -10000000 :references 50000))
